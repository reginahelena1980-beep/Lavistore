...
export const CategoryManager: React.FC<CategoryManagerProps> = ({
  ...
  return (
    <div className="space-y-8 animate-in fade-in font-['Comfortaa']">
      ...
      <div className="bg-gradient-to-r from-amber-100/95 via-yellow-50/90 to-pink-100/90 rounded-3xl p-6 sm:p-8 border-2 border-amber-300 shadow-md flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
        <div className="space-y-2 max-w-2xl">
          <div className="inline-flex items-center gap-1.5 bg-amber-200/90 text-purple-950 px-3 py-1 rounded-full text-xs font-bold border border-amber-300 shadow-2xs">
          ...
          <p className="text-xs sm:text-sm text-purple-900 font-medium leading-relaxed">
            Edite os nomes, emojis, descrições e a ordem das categorias que aparecem na lista de 
            <strong className="text-purple-950"> "Categorias Principais" do Rodapé</strong>, nos filtros da vitrine e no cadastro de produtos.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2.5 w-full lg:w-auto">
          <button
            ...
            className="flex-1 sm:flex-none px-4 py-2.5 bg-gradient-to-r from-[#F43F5E] via-[#FB923C] to-[#FACC15] hover:opacity-95 text-white rounded-2xl text-xs font-bold flex items-center justify-center gap-2 shadow-md transition-transform active:scale-95"
          >
          ...
          <button
            ...
            className="px-3.5 py-2.5 bg-white hover:bg-rose-50 text-purple-900 hover:text-rose-700 rounded-2xl text-xs font-bold border-2 border-amber-200 transition-colors flex items-center gap-1.5 shadow-2xs"
          ...
          {hasUnsavedChanges && (
            <button
              ...
              className="px-5 py-2.5 bg-purple-950 hover:bg-purple-900 text-amber-300 rounded-2xl text-xs font-bold flex items-center gap-1.5 shadow-md animate-pulse"
            >
      ...
      {/* Notification Toast */}
      {saveToast && (
        <div className="bg-amber-100 border-2 border-amber-400 text-purple-950 p-3.5 rounded-2xl font-bold text-xs flex items-center justify-between shadow-md animate-in fade-in">
